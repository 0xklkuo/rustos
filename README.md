...
- the current memory milestone validates real UEFI memory-map discovery and a minimal frame allocator seed derived from the first discovered conventional memory range, while paging and heap support remain deferred.
